...
class FireboostApi
{
    ...
    {
        $this->deleteAllCacheWithHttpInfo();
    }

    /**
     * Operation deleteAllCacheWithHttpInfo
     *
     *
     * @throws \FireboostIO\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function deleteAllCacheWithHttpInfo()
    {
        $request = $this->deleteAllCacheRequest();
    ...
    /**
     * Operation deleteAllCacheAsync
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAllCacheAsync()
    {
        return $this->deleteAllCacheAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteAllCacheAsyncWithHttpInfo
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAllCacheAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->deleteAllCacheRequest();
    ...
    /**
     * Create request for operation 'deleteAllCache'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteAllCacheRequest()
    {

        $resourcePath = '/v1/cache/delete-all';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \FireboostIO\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FireboostIO\Model\GetAllOutput|\FireboostIO\Model\InlineResponse401|\FireboostIO\Model\InlineResponse404|\FireboostIO\Model\InlineResponse423
     */
    public function getAllCache($cursor = null)
    {
        list($response) = $this->getAllCacheWithHttpInfo($cursor);
        return $response;
    }

    /**
     * Operation getAllCacheWithHttpInfo
     *
     * @param  string $cursor (optional)
     *
     * @throws \FireboostIO\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FireboostIO\Model\GetAllOutput|\FireboostIO\Model\InlineResponse401|\FireboostIO\Model\InlineResponse404|\FireboostIO\Model\InlineResponse423, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllCacheWithHttpInfo($cursor = null)
    {
        $request = $this->getAllCacheRequest($cursor);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FireboostIO\Model\GetAllOutput' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\FireboostIO\Model\GetAllOutput', []),
            ...
            $returnType = '\FireboostIO\Model\GetAllOutput';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\FireboostIO\Model\GetAllOutput',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllCacheAsync($cursor = null)
    {
        return $this->getAllCacheAsyncWithHttpInfo($cursor)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllCacheAsyncWithHttpInfo
     *
     * @param  string $cursor (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllCacheAsyncWithHttpInfo($cursor = null)
    {
        $returnType = '\FireboostIO\Model\GetAllOutput';
        $request = $this->getAllCacheRequest($cursor);
    ...
    /**
     * Create request for operation 'getAllCache'
     *
     * @param  string $cursor (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllCacheRequest($cursor = null)
    {

        $resourcePath = '/v1/cache/get-all';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
